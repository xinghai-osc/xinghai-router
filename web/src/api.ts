export interface User { id: string; email: string; name: string; role: string; enabled: boolean; permissions: string[]; created_at: string }
export interface ApiKey { id: string; user_id: string; name: string; key_prefix: string; expires_at: string | null; revoked_at: string | null; last_used_at: string | null; created_at: string }
export interface Channel { id: string; name: string; base_url: string; models: string[]; enabled: boolean; priority: number; created_at: string }
